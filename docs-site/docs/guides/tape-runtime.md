...
| **8** ✅ | This PR | Console **Runs** tab: filterable run list (tenant / agent / has-UNKNOWN / has-obligations) + per-run timeline with kind-coloured event rows, auto-refresh every 3–5s. |
